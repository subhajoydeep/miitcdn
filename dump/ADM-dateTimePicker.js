...
(function(angular) {
    ...
    String.prototype.toEnglishDigits = function(){
        var id= {'Û°':'0','Û±':'1','Û²':'2','Û³':'3','Û´':'4','Ûµ':'5','Û¶':'6','Û·':'7','Û¸':'8','Û¹':'9'};
        return this.replace(/[^0-9.]/g, function(w){
            return id[w]||w;
        });
    };
    ...
    var ADMdtpProvider = function() {
        ...
        var options = {
            ...
            jalaliDic: {
                title: 'Ø¬Ù„Ø§Ù„ÛŒ',
                monthsNames: ['Ù�Ø±ÙˆØ±Ø¯ÛŒÙ†', 'Ø§Ø±Ø¯ÛŒØ¨Ù‡Ø´Øª', 'Ø®Ø±Ø¯Ø§Ø¯', 'ØªÛŒØ±', 'Ù…Ø±Ø¯Ø§Ø¯', 'Ø´Ù‡Ø±ÛŒÙˆØ±', 'Ù…Ù‡Ø±', 'Ø¢Ø¨Ø§Ù†', 'Ø¢Ø°Ø±', 'Ø¯ÛŒ', 'Ø¨Ù‡Ù…Ù†', 'Ø§Ø³Ù�Ù†Ø¯'],
                daysNames: ['Ø´', 'ÛŒ', 'Ø¯', 'Ø³', 'Ú†', 'Ù¾', 'Ø¬'],
                todayBtn: 'Ø§Ù…Ø±ÙˆØ²'
            }
        };
