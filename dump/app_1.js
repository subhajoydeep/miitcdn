...
//                    !='' && $scope.bdup.date!='' && $scope.bdup.month!='' && $scope.bdup.year!='')
//            {
...
//                $log.log(data);
        ...
        $scope.up_bd_ses=function(id)
        {
            ...
            {
                $scope.bd=data1; 
                $scope.user_name=datsa1.user_name; 
                $scope.getgenhoro();                
            });            
        }
...
//                                var dtx=$scope.dtpick.split('-');
                    ...
                    "type"      :   d1,
                    'item'      :   $scope.selAdnItm,
                    'subfea'    :   d3+','+dt+','+$scope.sel_city_puja+','+$scope.puja_type+','+$scope.pt_radio+','+$scope.uaddr[$scope.addrsel]['udl_id']
                    };
                    $log.log('Params');
                    $log.log($scope.params);
                    $http({
